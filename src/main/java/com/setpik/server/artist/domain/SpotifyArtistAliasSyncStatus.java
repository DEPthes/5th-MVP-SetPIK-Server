...
@Entity
@Table(name = "Spotify_Artist_Alias_Sync_Status")
public class SpotifyArtistAliasSyncStatus extends BaseEntity {
	...
	protected SpotifyArtistAliasSyncStatus() {
	}

	private SpotifyArtistAliasSyncStatus(Long artistId, ArtistAliasResolutionStatus resolutionStatus,
	...
	public static SpotifyArtistAliasSyncStatus of(Long artistId, ArtistAliasResolutionStatus status,
		String externalEntityId, LocalDateTime attemptedAt) {
		return new SpotifyArtistAliasSyncStatus(artistId, status, externalEntityId, attemptedAt);
	}
